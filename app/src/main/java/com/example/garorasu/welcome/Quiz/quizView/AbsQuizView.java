...
package com.example.garorasu.welcome.Quiz.quizView;
...
import com.example.garorasu.welcome.Quiz.CheckableFab;
import com.example.garorasu.welcome.Quiz.Quiz;
import com.example.garorasu.welcome.Quiz.QuizActivity;

import com.example.garorasu.welcome.Quiz.ViewUtils;
import com.example.garorasu.welcome.R;


/**
 * This is the base class for displaying a {@link com.example.garorasu.welcome.Quiz.Quiz}.
 * <p>
 ...
 * </p>
 *
 * @param <Q> The type of {@link com.example.garorasu.welcome.Quiz.Quiz} you want to
 * display.
 */
public abstract class AbsQuizView<Q extends Quiz> extends FrameLayout {
     ...
     * @param category The {@link com.example.garorasu.welcome.Quiz.Category.Category} this view is running in.
     * @param quiz The actual {@link com.example.garorasu.welcome.Quiz.Quiz} that is going to be displayed.
     */
